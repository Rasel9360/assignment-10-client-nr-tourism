                ...
                <div className="md:flex justify-center items-center gap-10">
                    ...
                    <div className="space-y-4 md:w-[60%]">
                        <details className="w-full border rounded-lg">
                            ...
                            <p className="px-4 py-6 pt-0 ml-4 -mt-4 ">In Bangladesh, you shouldn't miss iconic landmarks such as Dhaka, Cox's Bazar, and Bandarban. These sites offer unique experiences and showcase the rich cultural heritage of our region. </p>
                        </details>
                        <details className="w-full border rounded-lg">
                        ...
                        <details className="w-full border rounded-lg">
                            ...
                            <p className="px-4 py-6 pt-0 ml-4 -mt-4 ">Absolutely! Thailand is a fantastic destination for families, with a plethora of attractions suitable for all ages. Enjoy fun-filled days at theme parks, interactive museums, and animal sanctuaries, ensuring unforgettable memories for the whole family.</p>
                        </details>
                        <details className="w-full border rounded-lg">
